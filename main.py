...
def init():
    ...
    parser.add_argument("--name", help = "test case path", required = True)
    parser.add_argument("--input", help = "test inputs file path", required = True)
    parser.add_argument("--output", help = "test outputs file path", required = True)
    parser.add_argument("--golden", help = "golden file path for comparison", required = True)
